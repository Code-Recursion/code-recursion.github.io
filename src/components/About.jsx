  ...
  return (
    <>
              ...
              <div className='col-11  mx-auto'>
                ...
                <div className='social_links  mt-4 d-flex justify-content-center'>
                  <a
                    ...
                    target='_blank'
                  >
                    <img className='m-1' src={Linkedin}></img>
                  </a>
                  ...
                  <a
                    ...
                    target='_blank'
                  >
                    <img className='m-1' src={Email}></img>
                  </a>
                </div>
      ...
      <section id='about-2'>
            ...
            <div className='row'>
              <div className='col-md-6 col-12-xs'>
                ...
                <p className='text-muted'>
                  B.Tech (Information Technology) Current - 5th Sem
                </p>
                <p className='text-muted'>2018 - Present</p>
                <p className=''>Kendriya Vidyalaya No. 1, Bhopal</p>
                <p className='text-muted'>Schooling (Maths Science)</p>
                <p className='text-muted'>2007 - 2018</p>
                <h5 className=''>What do i do?</h5>
                <ul className=''>
                  <li className=''>Web Development</li>
                  <li className=''>Android Development</li>
                </ul>
              </div>
              <div className='col-md-6 col-12-xs'>
                <p>I am an Aspiring Full Stack Developer.</p>
                <p>
                  I Like C++ and JavaScript, currently heading towards Mastering
                  Data Structures and Algorithms, Im a beginner in Competitive
                  Programming and do practice it in my free time. Open source
                  Enthusiast.{' '}
                </p>
                <p className='text-muted'>
                  I love listening to English music and playing football.
                </p>
        ...
        <div className='container_arrow pt-4 pb-5 d-flex justify-content-center floating arrow-up'>
          <a href='#about1'>
            <img id='arrow-to-up' src={Arrow}></img>
          </a>
        </div>
      </section>
      ...
      {/* <section className='section-experimental'> */}
        {/* <div className='heading-exp'>
          <h1 className='text-center position-relative experiments-heading'>
            Experimental
          </h1>
          <div className='container mt-3 p-0 d-flex justify-content-center'>
            <div
              class='alert alert-info alert-dismissible fade show w-75 d-lg-block d-none'
              role='alert'
            >
